...
\newcommand{\publicationwithabstract}[2]{%
  #1\\[0.3em]
  {\small \hangindent=1.5em \hangafter=0 \textbf{Abstract.} \hspace{0.1em} #2}\\[0.4em]
}
...
\publication{\hrefhidden{https://warwick.ac.uk/fac/soc/economics/research/workingpapers/2025/twerp_1577-_van_rens.pdf}{Why did we think wages are rigid for all those years?}, with See-Yu Chan and Thijs van Rens}
...
\cvitem{Class Teacher -- EC2B1 Macroeconomics II, LSE}{2022--2023}
\cvitem{Class Teacher -- EC210 Macroeconomic Principles, LSE}{2021--2022}
\cvitem{Class Teacher -- Tools for Macroeconomists: Advanced Tools (Summer School)}{2023,2024}
